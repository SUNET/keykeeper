...
stage4/packages: sys-devel/bc sys-boot/grub:2 app-crypt/ccid sys-apps/rng-tools sys-apps/usbutils app-arch/rpm dev-python/pip dev-libs/openssl dev-lang/swig sci-mathematics/ent
